...
export default function PuchaseOrderList() {
  ...
  const cancelPurchaseOrder = (id: number) => {
      Swal.fire({
          ...
          text: "Are you sure you want to cancel the purchase order?.",
          icon: "warning",
          showCancelButton: true,
          confirmButtonColor: "#dc2626",
          cancelButtonColor: "#6b7280",
          ...
          if (result.isConfirmed) {
              router.put(`/admin/purchase-order/${id}`);
          }
      });
  };
          ...
          {poDetails.data.length > 0 ? (
              poDetails.data.map((po: any) => (
                      ...
                      >
                          ...
                          <td className="p-4">{po.po_date}</td>
                          <td className="p-4">{Number(po.grand_total).toLocaleString()}</td>
                          <td className="p-4"><StatusBadge status={po.status} /></td>
                          <td className="p-4">{po.first_name} {po.last_name}</td>
                          <td className="p-4"><PurchaseOrderActions po={po} onDelete={deletePurchaseOrder} onCancel={cancelPurchaseOrder}/></td>
                      </tr>
                  ))
              ) : (
                  <tr>
                      ...
                      >
                          <div className="flex flex-col items-center gap-3">
                              ...
                              <p className="text-sm text-gray-400">
                                  Create your first Purchase Order to begin purchasing.
                              </p>
        ...
        {poDetails.data.map((po: any) => (
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-2 mt-4">
              ...
              <PurchaseOrderActions po={po} onDelete={deletePurchaseOrder} onCancel={cancelPurchaseOrder}/>
