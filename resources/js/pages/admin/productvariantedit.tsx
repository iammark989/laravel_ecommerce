...
import { ArrowLeft, Upload, Save, Plus, ChevronDown, ChevronUp, Edit } from "lucide-react";
...
export default function EditVariantPage() {
    ...
    const { variants,categories,products,uoms,warehouses,variantPrices,priceLists } = usePage().props as any;
    ...
    const classInput = `w-full rounded-xl border px-4 py-3 transition-colors
    ${
        editOn
    ...
    const [ variant,setVariant ] = useState({
        ...
        //base_uom_id:"",
        selling_uom_id:variants.selling_uom_id,
        purchasing_uom_id:variants.purchasing_uom_id,
        selling_qty:variants.selling_qty,
        purchasing_qty:variants.purchasing_qty,
    });
            ...
            <div className="min-h-screen bg-slate-50 p-4 md:p-6">
                            ...
                            <div className="flex items-center justify-between rounded-xl border bg-gray-50 p-4">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <button
                                        ...
                                        disabled={!editOn}
                                        className={`${editOn ? 'hover:cursor-pointer' : ''} relative h-8 w-14 rounded-full transition-colors duration-300 ${
                                            variant.is_active
                                                ? "bg-sky-500"
                                                : "bg-gray-300"
                                        }`}
              ...
              {/** right side */}
                 <div className="space-y-5">
                                ...
                                <select
                                    className={`${editOn ? 'hover:cursor-pointer' : 'bg-gray'}w-full rounded-xl border border-gray-300 bg-white px-4 py-3 focus:border-sky-500 focus:ring-2 focus:ring-sky-200`}
                                    required
                                    disabled={!editOn}
                    ...
                    <div className="border-t mt-8 pt-6 flex flex-col sm:flex-row gap-3 justify-end">
                        ...
                        type="button" hidden={editOn} className="hover:cursor-pointer px-6 py-3 bg-sky-500 hover:bg-sky-600 text-white rounded-xl flex items-center justify-center gap-2">
                            <Edit size={18} />
                            Edit
                        </button>
                        
                        <button hidden={!editOn} disabled={saving} className="hover:cursor-pointer px-6 py-3 bg-sky-500 hover:bg-sky-600 text-white rounded-xl flex items-center justify-center gap-2">
                            <Save size={18} />
